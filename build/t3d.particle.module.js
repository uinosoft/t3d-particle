...
import { ShaderChunk, Loader, BoxGeometry, SphereGeometry, FileLoader, Object3D, Vector2, Vector3, Color3, Geometry, Attribute, Buffer } from 't3d';
...
class AbstractParticleGroup {
	...
	constructor(options, shader) {
		...
		this.material.blending = Utils.ensureTypedArg(options.blending, types.STRING, t3d.BLEND_TYPE.ADD);
	...
	setTextureValue(value) {
		this.uniforms.tex = Utils.ensureInstanceOf(value, t3d.Texture2D, defaultTexture);
	}
 ...
 */
class ParticleLoader extends Loader {
...
export { MeshParticleEmitter, MeshParticleGroup, ParticleEmitter, ParticleGroup, ParticleLoader, ParticleProperties };
